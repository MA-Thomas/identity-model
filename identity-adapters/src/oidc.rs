...
use identity_model::time::{timestamp_to_unix_seconds, unix_seconds_to_timestamp};
use identity_model::Timestamp;
...
impl JwtOidcClaims {
    fn into_verified_session(
        ...
        Ok(VerifiedOidcSession {
            ...
            issued_at: unix_seconds_to_timestamp(
                self.iat
                    .ok_or(OidcSessionVerificationError::InvalidSessionTimestamp)?,
            ),
